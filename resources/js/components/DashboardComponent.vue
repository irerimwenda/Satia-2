...
import { Form, HasError, AlertError } from 'vform'
    ...
    export default {
        ...
        methods: {
            ...
            deleteLink(id) {
                this.form.delete('/api/delete-link/' + id)
                .then(response => {
                    Toast.fire({
                        type: 'success',
                        title: 'Link deleted!'
